...
def page_model():
    ...
    st.plotly_chart(fig_q, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False})
    ...
    with col2:
        ...
        st.plotly_chart(fig_loss, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False})
    ...
    st.plotly_chart(fig_feat, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False})
